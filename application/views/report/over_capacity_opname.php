            ...
            <table class="table table-bordered table-striped no-datatable responsive no-wrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a href="<?= site_url('')?>report/over-capacity-detail-opname?no_reference=<?= $overCapacity['no_reference_inbound'] ?>&&bookingId=<?= $overCapacity['id_booking'] ?>" target="_blank"> 
                        <?php if($overCapacity['sum_space']==0): ?>
                            <?= (!empty($overCapacity['sum_space'])||!empty($overCapacity['sum_space_cal']))?(!empty($overCapacity['sum_space_cal'])? $overCapacity['sum_space_cal'] ." (".if_empty($overCapacity['sum_space'],0).")" : $overCapacity['sum_space']):'-' ?> </a> m<sup>2</sup></td>    
                        <?php else: ?>
                            <?= (!empty($overCapacity['sum_space'])||!empty($overCapacity['sum_space_cal']))?(!empty($overCapacity['sum_space_cal'])? $overCapacity['sum_space_cal'] ." (".if_empty($overCapacity['sum_space'],0).")" : $overCapacity['sum_space']):'-' ?> (<?= $overCapacity['space_diff']>0 ? '+' : '' ?><?= numerical($overCapacity['space_diff']/abs(if_empty($overCapacity['sum_space'],0))*100,0) ?>%) </a> m<sup>2</sup></td>
                        <?php endif; ?>
