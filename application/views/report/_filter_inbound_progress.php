<form role="form" method="get" class="form-filter" id="form-filter-inbound-progress" <?= (isset($hidden) && $hidden) ? 'style="display:none"' : ''  ?>>
    <input type="hidden" name="filter_inbound_progress" value="1">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control datepicker" id="date_from" name="date_from"
                                       ...
                                       maxlength="50" value="<?= get_url_param('filter_inbound_progress') ? set_value('date_from', get_url_param('date_from')) : '' ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="date_to">Date To</label>
                                <input type="text" class="form-control datepicker" id="date_to" name="date_to"
                                       placeholder="Date to" autocomplete="off"
                                       maxlength="50" value="<?= get_url_param('filter_inbound_progress') ? set_value('date_to', get_url_param('date_to')) : '' ?>">
                            </div>
                        </div>
                    </div>
                </div>
