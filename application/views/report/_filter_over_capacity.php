<form role="form" method="get" class="form-filter" id="filter_over_capacity" <?= (isset($hidden) && $hidden) ? 'style="display:none"' : ''  ?>>
    <input type="hidden" name="filter_over_capacity" value="1">
