<div class="box box-primary">
    <div class="box-header">
        <h3 class="box-title">Request Complete Detail Week <?= substr(get_url_param('year_week',0),-2) ?></h3>
    ...
    <div class="box-body">
        ...
        <table class="table table-bordered table-striped responsive" id="table-sppb-detail">
            ...
            <?php
            $total_day+= $data['diff_date_complete'];
             ?>
                <tr>
                    <td><?= $no++ ?></td>
                    ...
                    <td><?= format_date($data['request_date'], 'd F Y H:i')?></td>
                    <td><?= if_empty($data['no_work_order'], '-')?></td>
                    <td><?= format_date($data['completed_at'], 'd F Y H:i')?></td>
                    <td><?= if_empty($data['diff_date_complete'], '-')?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
            <tfoot>
