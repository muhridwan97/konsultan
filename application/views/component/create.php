<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Create New Handling Component</h3>
    </div>
    <form action="<?= site_url('component/save') ?>" role="form" method="post" class="need-validation" id="form-handling-component">
        <div class="box-body">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('handling_component') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" id="handling_component" name="handling_component"
                               ...
                               required maxlength="100" value="<?= set_value('handling_component') ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('component_category') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" id="component_category" name="component_category"
                               ...
                               required maxlength="50" value="<?= set_value('component_category') ?>">
        ...
        <div class="box-footer clearfix">
            ...
            <button type="submit" data-toggle="one-touch" class="btn btn-primary pull-right" id="btn-save-handling-component">
                Save Handling Component
            </button>
        </div>
    </form>
</div>