<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Edit Handling Type</h3>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    <form action="<?= site_url('handling_type/update/' . $handlingType['id']) ?>" role="form" method="post"
          id="form-handling-type">
        <div class="box-body">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('handling_type') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" id="handling_type" name="handling_type"
                               ...
                               value="<?= set_value('handling_type', $handlingType['handling_type']) ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('handling_code') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" id="handling_code" name="handling_code"
                               ...
                               value="<?= set_value('handling_code', $handlingType['handling_code']) ?>">
                    ...
                    <div class="form-group <?= form_error('category') == '' ?: 'has-error'; ?>">
                        ...
                        <select class="form-control select2" name="category" id="category"
                            ...
                            <option value="<?= HandlingTypeModel::CATEGORY_WAREHOUSE ?>"
                                <?= $handlingType['category'] == HandlingTypeModel::CATEGORY_WAREHOUSE ? 'selected' : '' ?>>
                                <?= HandlingTypeModel::CATEGORY_WAREHOUSE ?>
                            </option>
                            <option value="<?= HandlingTypeModel::CATEGORY_NON_WAREHOUSE ?>"
                                <?= $handlingType['category'] == HandlingTypeModel::CATEGORY_NON_WAREHOUSE ? 'selected' : '' ?>>
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('duration') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" name="duration" min="0" class="form-control" required
                               placeholder="Enter duration of handling type"
                               value="<?= set_value('duration', $handlingType['duration']) ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('container_multiplier') == '' ?: 'has-error'; ?>">
                        ...
                        <select class="form-control select2" name="container_multiplier" id="container_multiplier"
                            ...
                            <option value=""></option>
                            <option value="-1"
                                <?= set_select('container_multiplier', -1, $handlingType['multiplier_container'] == -1) ?>>
                                SUBTRACTION (-)
                            </option>
                            <option value="0"
                                <?= set_select('container_multiplier', 0, $handlingType['multiplier_container'] == 0) ?>>
                                NOT AFFECTING (-/+)
                            </option>
                            <option value="1"
                                <?= set_select('container_multiplier', 1, $handlingType['multiplier_container'] == 1) ?>>
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('goods_multiplier') == '' ?: 'has-error'; ?>">
                        ...
                        <select class="form-control select2" name="goods_multiplier" id="goods_multiplier"
                            ...
                            <option value=""></option>
                            <option value="-1"
                                <?= set_select('goods_multiplier', -1, $handlingType['multiplier_goods'] == -1) ?>>
                                SUBTRACTION (-)
                            </option>
                            <option value="0"
                                <?= set_select('goods_multiplier', 0, $handlingType['multiplier_goods'] == 0) ?>>
                                NOT AFFECTING (-/+)
                            </option>
                            <option value="1"
                                <?= set_select('goods_multiplier', 1, $handlingType['multiplier_goods'] == 1) ?>>
            ...
            <div class="form-group <?= form_error('handling_type') == '' ?: 'has-error'; ?>">
                ...
                <div class="checkbox icheck" style="margin-top: 0">
                    <label>
                    <input type="checkbox" name="photo" id="photo" value="1"<?= $handlingType['photo'] == 1 ? 'checked': ''; ?>>
                        With Photo
                    </label>
                </div>
            </div>
            <div class="form-group <?= form_error('description') == '' ?: 'has-error'; ?>">
                ...
                <textarea class="form-control" id="description" name="description"
                          ...
                          required
                          maxlength="500"><?= set_value('description', $handlingType['description']) ?></textarea>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="table no-datatable" id="table-detail-attachment-photo">
                            ...
                            <tr class="row-photo">
                                ...
                                <td>
                                    <select class="form-control select2" name="attachmentPhotos[]" id="detail_photo"
                                            data-placeholder="Select photo" required style="width: 100%">
                                        <option value=""></option>
                                        <?php foreach ($attachmentPhotos as $attachmentPhoto): ?>
                                            <option value="<?= $attachmentPhoto['id'] ?>" <?= $handlingTypePhoto['id'] == $attachmentPhoto['id'] ? 'selected' : '' ?>>
                                ...
                                <select class="form-control select2" name="conditions[]" id="condition"
                                    ...
                                    <option value="TAKE" <?= set_select('conditions[]', $handlingTypePhoto['condition'], $handlingTypePhoto['condition'] == 'TAKE') ?>>TAKE</option>
                                    <option value="COMPLETED" <?= set_select('conditions[]', $handlingTypePhoto['condition'], $handlingTypePhoto['condition'] == 'COMPLETED') ?>>COMPLETED</option>
                                    <option value="CHECK" <?= set_select('conditions[]', $handlingTypePhoto['condition'], $handlingTypePhoto['condition'] == 'CHECK') ?>>CHECK</option>
                                </select>
                            </td>
                                <td>
                                    <input type="text" class="form-control" name="descriptionPhotos[]" id="detail_description_photo"
                                           value="<?= $handlingTypePhoto['photo_description'] ?>"
                        ...
                        <?php endforeach; ?>
                        <?php if (!count($handlingTypePhotos)): ?>
                            <tr>
                    ...
                    <button type="button" class="btn btn-block btn-primary mt10" id="btn-add-photo">
                        ADD NEW SUB HANDLING ATTACHMENT PHOTO
                    </button>
                </div>
            </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <table class="table no-datatable" id="table-detail-handling-component">
                        ...
                        <tbody>
                        <?php $no = 1;
                        foreach ($handlingTypeComponents as $handlingTypeComponent): ?>
                            <tr class="row-component">
                                ...
                                <td>
                                    <select class="form-control select2" name="components[]" id="detail_component"
                                        ...
                                        <?php foreach ($components as $component): ?>
                                            <option value="<?= $component['id'] ?>" <?= $handlingTypeComponent['id'] == $component['id'] ? 'selected' : '' ?>>
                                ...
                                <td>
                                    <input type="number" min="0" step="any" class="form-control" name="default_values[]" id="default_value"
                                           value="<?= $handlingTypeComponent['default_value'] ?>"
                                           placeholder="Default value">
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="descriptions[]" id="detail_description"
                                           value="<?= $handlingTypeComponent['component_description'] ?>"
                                           placeholder="Description">
                                </td>
                                <td class="text-center">
        ...
        <div class="box-footer clearfix">
            ...
            <button type="submit" data-toggle="one-touch" class="btn btn-warning pull-right" id="btn-save-handling-type">
