<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Weekly Validation</h3>
    </div>

    <div class="box-body">
        <?php $this->load->view('template/_alert') ?>

        <table class="table table-bordered table-striped table-ajax responsive" id="table-storage-over-space" data-type="weekly">
            <thead>
            <tr>
