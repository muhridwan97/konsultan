<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="<?= site_url('component_order/save') ?>" role="form" method="post" enctype="multipart/form-data" id="form-component-transaction">
        <div class="box-body">
            ...
            <div class="form-group <?= form_error('no_transaction') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control" id="no_transaction" name="no_transaction"
                       ...
                       required maxlength="50" value="<?= set_value('no_transaction') ?>">
            ...
            <div class="form-group <?= form_error('transaction_date') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control daterangepicker2" id="transaction_date" name="transaction_date"
                       ...
                       required maxlength="50" value="<?= set_value('transaction_date') ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('quantity') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="quantity" name="quantity"
                               ...
                               required value="<?= set_value('quantity') ?>">
            ...
            <div class="form-group <?= form_error('option') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control" id="option" name="option"
                       ...
                       maxlength="50" value="<?= set_value('option') ?>">
        ...
        <div class="box-footer clearfix">
            ...
            <button type="submit" data-toggle="one-touch" class="btn btn-primary pull-right">Save Component Order</button>
        </div>
    </form>
</div>
<!-- /.box -->