<div class="box box-primary">
    ...
    <form action="<?= site_url('transporter-entry-permit/save') ?>" role="form" method="post" id="form-tep-manual">
        <div class="box-body">
            ...
            <div class="form-group <?= form_error('customer') == '' ?: 'has-error'; ?> customer-wrapper">
                ...
                <select class="form-control select2 select2-ajax"
                        ...
                        data-placeholder="Select customer" style="width: 100%" multiple required>
                    <option value=""></option>
                </select>
