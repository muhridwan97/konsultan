<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Create Auction</h3>
    </div>

    <form action="<?= site_url('auction/save') ?>" role="form" method="post" id="form-auction">
        <div class="box-body">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('no_doc') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" name="no_doc" id="no_doc" class="form-control" required
                               placeholder="Auction document number" value="<?= set_value('no_doc') ?>">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="table no-datatable" id="table-detail-booking">
                        ...
                        <tbody>
                        <?php $bookingData = set_value('bookings[booking]', []); ?>
                                ...
                                <tr class="row-booking">
                                    ...
                                    <td>
                                        <select class="form-control select2" name="bookings[booking][]" id="detail_booking"
                                            ...
                                            <?php foreach ($bookings as $booking): ?>
                                                <option value="<?= $booking['id_booking'] ?>" <?= set_select('bookings[booking]['.$i.']', $booking['id_booking']) ?>>
                                    ...
                                    <td>
                                        <input class="form-control" name="bookings[description][]" id="detail_description"
                                               placeholder="Description" type="text" value="<?= set_value('bookings[description]['.$i.']') ?>" maxlength="500">
                                    </td>
