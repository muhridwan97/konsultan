                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="status" id="status" data-placeholder="Request status">
                                <?php
                                $filterStatuses = [
                                    TransporterEntryPermitRequestHoldModel::STATUS_HOLD,
                                    TransporterEntryPermitRequestHoldModel::STATUS_PARTIAL_RELEASE,
                                    TransporterEntryPermitRequestHoldModel::STATUS_RELEASED,
                                ];
                                ?>
