<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">View Request Hold</h3>
    </div>
    <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-sm-4">No Hold Reference</label>
                        <div class="col-sm-8">
                        ...
                        <div class="col-sm-8">
                            <p class="form-control-static">
                                ...
                                <span class="label label-<?= get_if_exist($statuses, $tepRequestHold['hold_status'], 'default') ?>">
                                    <?= $tepRequestHold['hold_status'] ?: 'HOLD' ?>
                                </span>
                            </p>
                        </div>
                    </div>
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Hold Items</h3>
            </div>
            <div class="box-body">
