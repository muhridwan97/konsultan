    ...
    <form action="<?= site_url('transporter-entry-permit-request-priority/update') ?>?<?= $_SERVER['QUERY_STRING'] ?>" role="form" method="post" class="need-validation">
        <div class="box-body">
            ...
            <?php foreach ($tepRequestUploads as $tepRequestUpload): ?>
                <input type="hidden" name="tep_request_unloads[<?= $tepRequestUpload['id'] ?>]" value="<?= $tepRequestUpload['id'] ?>">
            <?php endforeach; ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group <?= form_error('unload_location') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control input-uppercase" id="unload_location" name="unload_location" placeholder="Unloading location"
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('priority') == '' ?: 'has-error'; ?>">
                        ...
                        <select class="form-control select2" name="priority" id="priority" data-placeholder="Select priority" required style="width: 100%">
                            <option value=""></option>
            ...
            <div class="form-group <?= form_error('description') == '' ?: 'has-error'; ?>">
                ...
                <textarea class="form-control" id="description" name="description" placeholder="Priority description" required
