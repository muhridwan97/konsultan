<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Edit Service Hour</h3>
    </div>

    <form action="<?= site_url('service-hour/update/' . $serviceHour['id']) ?>" role="form" method="post" id="form-service-hour">
        <div class="box-body">
            ...
            <div class="form-group <?= form_error('service_day') == '' ?: 'has-error'; ?>">
                ...
                <select class="form-control select2" name="service_day" id="service_day" data-placeholder="Select day" required>
                    <option value=""></option>
                    <option value="SUNDAY"<?= set_select('service_day', 'SUNDAY', $serviceHour['service_day'] == 'SUNDAY') ?>>SUNDAY</option>
                    <option value="MONDAY"<?= set_select('service_day', 'MONDAY', $serviceHour['service_day'] == 'MONDAY') ?>>MONDAY</option>
                    <option value="TUESDAY"<?= set_select('service_day', 'TUESDAY', $serviceHour['service_day'] == 'TUESDAY') ?>>TUESDAY</option>
                    <option value="WEDNESDAY"<?= set_select('service_day', 'WEDNESDAY', $serviceHour['service_day'] == 'WEDNESDAY') ?>>WEDNESDAY</option>
                    <option value="THURSDAY"<?= set_select('service_day', 'THURSDAY', $serviceHour['service_day'] == 'THURSDAY') ?>>THURSDAY</option>
                    <option value="FRIDAY"<?= set_select('service_day', 'FRIDAY', $serviceHour['service_day'] == 'FRIDAY') ?>>FRIDAY</option>
                    <option value="SATURDAY"<?= set_select('service_day', 'SATURDAY', $serviceHour['service_day'] == 'SATURDAY') ?>>SATURDAY</option>
                </select>
                    ...
                    <div class="form-group <?= form_error('service_time_start') == '' ?: 'has-error'; ?>">
                        ...
                        <div class="input-group bootstrap-timepicker <?= form_error('service_time_start') == '' ?: 'has-error'; ?>">
                            <input type="text" class="form-control time-picker" id="service_time_start" name="service_time_start"
                                   placeholder="Service start" value="<?= set_value('service_time_start', format_date($serviceHour['service_time_start'], 'H:i')) ?>">
                    ...
                    <div class="form-group <?= form_error('service_time_end') == '' ?: 'has-error'; ?>">
                        ...
                        <div class="input-group bootstrap-timepicker <?= form_error('service_time_end') == '' ?: 'has-error'; ?>">
                            <input type="text" class="form-control time-picker" id="service_time_end" name="service_time_end"
                                   placeholder="Service end" value="<?= set_value('service_time_end', format_date($serviceHour['service_time_end'], 'H:i')) ?>">
                            <span class="input-group-btn">
                                <button class="btn btn-default" type="button"><i class="fa fa-clock-o"></i></button>
                            </span>
                        </div>
            ...
            <div class="form-group <?= form_error('effective_date') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control datepicker" name="effective_date" id="effective_date"
                       value="<?= set_value('effective_date', format_date($serviceHour['effective_date'], 'd F Y')) ?>" placeholder="Effective date of service">
            ...
            <div class="form-group <?= form_error('description') == '' ?: 'has-error'; ?>">
                ...
                <textarea class="form-control" id="description" name="description" placeholder="Service hour description"
                          maxlength="500"><?= set_value('description', $serviceHour['description']) ?></textarea>
