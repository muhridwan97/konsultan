            ...
            <form action="#" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <p class="lead" style="margin-bottom: 0">Are you sure want to change total print for Delivery Order<br>
                            <strong id="delivery-order-title"></strong>?</p>
                    </div>
                    <div class="row">
                        <div class="col-xs-4 col-md-3">
                            <div class="form-group">
                                <label class="control-label">Current DO Print</label>
                                <p class="form-control-static" id="delivery-order-print"></p>
                            </div>
                        </div>
