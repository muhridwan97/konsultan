<div class="box box-primary">
    ...
    <form action="<?= site_url('news/save') ?>" role="form" method="post" enctype="multipart/form-data">
        <div class="box-body">
            ...
            <div class="form-group <?= form_error('title') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control" id="title" name="title"
                       ...
                       required maxlength="200" value="<?= set_value('title') ?>">
            ...
            <div class="form-group <?= form_error('content') == '' ?: 'has-error'; ?>">
                ...
                <textarea class="form-control wysiwyg" id="content" name="content" placeholder="Content of the news"
                          required rows="10"><?= set_value('content') ?></textarea>
                ...
                <div class="col-md-3">
                    <div class="form-group <?= form_error('type') == '' ?: 'has-error'; ?>">
                        ...
                        <select class="form-control select2" name="type" id="type" data-placeholder="Privacy type" required>
                            <option value=""></option>
                            <option value="PUBLIC" <?= set_select('type', 'PUBLIC', true) ?>>PUBLIC (All user or visitor could access)</option>
                            <option value="EXTERNAL" <?= set_select('type', 'EXTERNAL') ?>>EXTERNAL (Registered external only)</option>
                            <option value="INTERNAL" <?= set_select('type', 'INTERNAL') ?>>INTERNAL (Employee of transcon only)</option>
                        </select>
                            ...
                            <div class="col-sm-5">
                                <label class="radio">
                                    <input type="radio" class="form-control" id="popup_yes" name="is_popup" value="1"
                                        <?= set_radio('is_popup', 1) ?>> <span>POPUP</span>
                                </label>
                            </div>
                            <div class="col-sm-5">
                                <label class="radio">
                                    <input type="radio" class="form-control" id="popup_no" name="is_popup" value="0"
                                        <?= set_radio('is_popup', 0, true) ?>> <span>NORMAL</span>
                                </label>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-5">
                                <label class="radio">
                                    <input type="radio" class="form-control" id="sticky_yes" name="is_sticky" value="1"
                                        <?= set_radio('is_sticky', 1) ?>> <span>STICKY</span>
                                </label>
                            </div>
                            <div class="col-sm-5">
                                <label class="radio">
                                    <input type="radio" class="form-control" id="sticky_no" name="is_sticky" value="0"
                                        <?= set_radio('is_sticky', 0, true) ?>> <span>NORMAL</span>
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-group <?= form_error('expired_date') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control daterangepicker2" id="expired_date" name="expired_date"
                       placeholder="Expired date" maxlength="500"
                       value="<?= set_value('plan_date', date('d F Y')) ?>">
                <?= form_error('expired_date', '<span class="help-block">', '</span>'); ?>
            </div>
            <div class="form-group <?= form_error('description') == '' ?: 'has-error'; ?>">
                <label for="description">Description</label>
                <textarea class="form-control" id="description" name="description" placeholder="additional information" maxlength="500"><?= set_value('description') ?></textarea>
