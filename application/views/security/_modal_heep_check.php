<div class="modal fade" tabindex="-1" role="dialog" id="modal-heep-check">
        ...
        <div class="modal-content">
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Security Check In : <strong>HEEP</strong></h4>
                </div>
...
background:#F5F5F5;webkit-touch-callout: none;" onkeydown="return false" placeholder="Capture Photo" required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" data-toggle="one-touch" class="btn btn-success btn-check">Check In</button>
                </div>
            </form>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
