...
<head>
    ...
    <title><?= $this->config->item('app_name') ?> | Password Recovery</title>
...
<div class="register-box" style="margin: 40px auto">
    ...
    <div class="register-box-body">
        ...
        <form action="<?= site_url('account/reset/' . $token) ?>" method="post">
            <div class="form-group has-feedback <?= form_error('email') == '' ?: 'has-error'; ?>">
                <input type="email" class="form-control" placeholder="Email" name="email" id="email" value="<?= $email ?>" required readonly>
                <span class="ion-email form-control-feedback"></span>
                <?= form_error('email', '<span class="help-block">', '</span>'); ?>
            </div>
            <div class="form-group has-feedback <?= form_error('new_password') == '' ?: 'has-error'; ?>">
                <input type="password" class="form-control" placeholder="New password" name="new_password" id="new_password" required minlength="5">
            ...
            <div class="form-group has-feedback <?= form_error('confirm_password') == '' ?: 'has-error'; ?>">
                <input type="password" class="form-control" placeholder="Retype password" name="confirm_password" id="confirm_password" required minlength="5">
        ...
        <div class="text-center">
            <a href="<?= site_url('welcome') ?>" class="text-center">I remember my password</a>
        </div>
    </div>
    <!-- /.form-box -->
</div>
