                        ...
                        <table style="<?php echo $style['email-body_inner'] ?>" align="center" width="570"
                            ...
                            <tr>
                                <td style="<?php echo $fontFamily ?> <?php echo $style['email-body_cell'] ?>">
                                    <!-- Greeting -->
                                    <h1 style="<?php echo $style['header-1'] ?>">Handling is <?= $handling['status'] ?></h1>

                                    <!-- Info -->
                                    <h3 style="<?php echo $style['paragraph'] ?>">
                                        Hello, <?php echo $customer['name'] ?>
                                    </h3>
                                    <p style="<?php echo $style['paragraph'] ?>">
                                        We recently receive email to manage a handling by your request, here we would inform you that your request have been approved.
                                        On <b><?= (new DateTime($handling['handling_date']))->format('d F Y H:i')?></b>
                                        handling type <b><?= $handling['handling_type'] ?></b> will be done by Handling No <b><?= $handling['no_handling'] ?></b>
                                        along with all necessary information that we need to accomplish the job.
                                    </p>

                                    <p style="<?php echo $style['paragraph'] ?>">
                                        <b>QR code handling: <?= $handling['no_handling'] ?> (See Attachment)</b>
                                    </p>

                                    <p style="<?php echo $style['paragraph'] ?>">
                                        Please print and bring your handling number or QR code to Transcon Indonesia.
                                        If you think this information wrong or irrelevant please contact our
                                        <a href="mailto:cso1@transcon-indonesia.com">support</a>
                                    </p>
                                        ...
                                        <tr>
                                            <td style="<?php echo $fontFamily ?>">
                                                <p style="<?php echo $style['paragraph-sub'] ?>">
                                                    This email was intended for <?php echo $customer['email'] ?>.<br>
