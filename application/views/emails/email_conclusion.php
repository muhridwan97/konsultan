...
$style = [
    ...
    'paragraph' => 'margin-top: 0; color: #000000; font-size: 14px; line-height: 1.5em;',
...
<?php $fontFamily = 'font-family: Calibri, \'Helvetica Neue\', Helvetica, sans-serif;'; ?>

<body style="<?php echo $style['body'] ?>">
<table width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td style="<?php echo $style['email-wrapper'] ?>" align="left">
            <table width="100%" cellpadding="0" cellspacing="0">
                <!-- Logo -->
                <tr>
                ...
                <tr>
                    <td style="<?php echo $style['email-body'] ?>" width="100%">
                        <table style="<?php echo $style['email-body_inner'] ?>" align="left" width="600"
                            ...
                            <tr>
                                <td style="<?php echo $fontFamily ?> <?php echo $style['email-body_cell'] ?>">
                                    ...
                                    <!-- <table style="<?php echo $style['body_action'] ?>" align="center" width="100%"
                                        ...
                                        <tr>
                                            <td align="center">
                                                <a href="mailto:<?= get_setting('email_support', 'cso1@transcon-indonesia.com') ?>"
                                        ...
                                        <tr>
                                            <td style="<?php echo $fontFamily ?>">
                                                <p style="<?php echo $style['paragraph-sub'] ?>">
                                                    This email was intended for <?php echo isset($email) ? $email : 'user' ?>.<br>
                ...
                <tr>
                    <td>
                        <table style="<?php echo $style['email-footer'] ?>" align="left" width="600" cellpadding="0" cellspacing="0">
                            <tr>
