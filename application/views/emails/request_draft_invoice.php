                        ...
                        <table style="<?php echo $style['email-body_inner'] ?>" align="center" width="570"
                            ...
                            <tr>
                                <td style="<?php echo $fontFamily ?> <?php echo $style['email-body_cell'] ?>">
                                    <!-- Greeting -->
                                    <h1 style="<?php echo $style['header-1'] ?>">Request Draft Invoice</h1>
                                    ...
                                    <p style="<?php echo $style['paragraph'] ?>">
                                        Here we would inform you that <?php echo $customer['name'] ?> request draft invoice:
                                        <br>No Invoice: <b><?= $request['no_invoice'] ?></b>
                                        <br>Date Inbound: <b><?= date('d F Y',strtotime($request['inbound_date'])) ?></b>
                                        <br>Date Outbound: <b><?= date('d F Y',strtotime($request['outbound_date'])) ?></b>
                                        <br>Time Request: <b><?= date('d F Y H:i:s')?></b>
                                        <br>Branch: <b><?=$request['branch'] ?></b>
                                    </p>
