                                ...
                                <td style="<?php echo $fontFamily ?> <?php echo $style['email-body_cell'] ?>">
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px; color: #2D2F31; font-size: 13px">
                                        ...
                                        <tr style="border-bottom: 1px solid #74787E; border-top: 1px solid #74787E;">
                                            ...
                                            <th colspan="3" style="padding: 5px 4px; text-align: center">Available Storage (M<sup>2</sup>)</th>
                                        </tr>
                                        ...
                                        <?php foreach ($customerStorages as $index => $customerStorage): ?>
                                            <tr style="border-bottom: 1px solid #74787E;">
                                                ...
                                                <td style="padding: 5px 4px"><?= $customerStorage['customer_name'] ?></td>
                                                <td style="padding: 5px 4px"><?= numerical($customerStorage['warehouse_capacity'], 2, true) ?> M<sup>2</sup></td>
                                                <td style="padding: 5px 4px"><?= numerical($customerStorage['yard_capacity'], 2, true) ?> M<sup>2</sup></td>
                                                <td style="padding: 5px 4px; border-right: 1px solid #74787E;"><?= numerical($customerStorage['covered_yard_capacity'], 2, true) ?> M<sup>2</sup></td>
                                                <td style="padding: 5px 4px">
                                                    <?= numerical($customerStorage['balance_warehouse_capacity'], 2, true) ?>
                                                    (<?= numerical($customerStorage['used_warehouse_percent'], 1, true) ?>% Used)
                                                </td>
                                                <td style="padding: 5px 4px">
                                                    <?= numerical($customerStorage['balance_yard_capacity'], 2, true) ?>
                                                    (<?= numerical($customerStorage['used_yard_percent'], 1, true) ?>% Used)
                                                </td>
                                                <td style="padding: 5px 4px">
                                                    <?= numerical($customerStorage['balance_covered_yard_capacity'], 2, true) ?>
                                                    (<?= numerical($customerStorage['used_covered_yard_percent'], 1, true) ?>% Used)
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
