<div class="box box-primary">
    ...
    <form action="<?= site_url('position/update/' . $position['id']) ?>" role="form" method="post" id="form-position" class="edit need-validation">
        ...
        <div class="box-body">
            ...
            <div class="form-group <?= form_error('warehouse') == '' ?: 'has-error'; ?>">
                ...
                <select class="form-control select2 select2-ajax"
                        ...
                        data-key-id="id" data-key-label="warehouse"
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group <?= form_error('position_type') == '' ?: 'has-error'; ?>">
                                ...
                                <select name="position_type" id="position_type" class="form-control select2">
                                    <?php foreach ($positionTypes as $positionType): ?>
                                        <option value="<?= $positionType['id'] ?>" data-is-usable="<?= $positionType['is_usable'] ?>" data-color="<?= $positionType['color'] ?>"<?= set_select('position_type', $positionType['id'], $positionType['id'] == $position['id_position_type']) ?>>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group <?= form_error('position') == '' ?: 'has-error'; ?>">
                                ...
                                <input type="text" class="form-control" id="position" name="position"
                                       ...
                                       required maxlength="50" value="<?= set_value('position', $position['position']) ?>">
                    ...
                    <div class="form-group <?= form_error('description') == '' ?: 'has-error'; ?>">
                        ...
                        <textarea class="form-control" id="description" name="description" placeholder="Position description"
                                  maxlength="500"><?= set_value('description', $position['description']) ?></textarea>
        ...
        <div class="box-footer clearfix">
            ...
            <button type="submit" data-toggle="one-touch" class="btn btn-success pull-right">Update Position</button>
        </div>
    </form>
</div>
