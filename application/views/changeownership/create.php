...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">Create New Change Ownership</h3>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    <form action="<?= site_url('change_ownership/save') ?>" class="form" method="post" id="form-changeOwnership">
        <div class="box-body">
            <!-- alert -->
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('newOwner') == '' ?: 'has-error'; ?>">
                        ...
                        <select class="form-control select2NewOwner" name="newOwner" id="newOwner" required></select>
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('changeDate') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control daterangepicker2" id="changeDate" name="changeDate"
                               ...
                               value="<?= set_value('changeDate', (new DateTime($this->input->post('changeDate')))->format('d F Y H:i:s')) ?>">
            ...
            <div class="form-group <?= form_error('description') == '' ?: 'has-error'; ?>">
                ...
                <textarea class="form-control" id="description" name="description"
                          placeholder="Ownership history description"
        ...
        <div class="box-footer">
            ...
            <button type="submit" data-toggle="one-touch" class="btn btn-primary pull-right">Change Ownership</button>
        </div>
        <!-- /.box-footer -->
    </form>
</div>
<script>
    ...
    //    <?//= !is_null($deliveryorder) ? "minDate:'" . (new DateTime(end($ownershiphistories)['change_date']))->format('d F Y H:i:s') . "'," : "" ?>
    //    locale: {
