<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Edit Safe Conduct Handover</h3>
    </div>

    <form action="<?= site_url('safe-conduct-handover/update/' . $safeConductHandover['id']) ?>" role="form" method="post" class="need-validation">
        <?= _method('put') ?>
        <input type="hidden" name="safe_conduct" value="<?= $safeConductHandover['id_safe_conduct'] ?>">
        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">
                            <a href="<?= site_url('safe-conduct/view/' . $safeConductHandover['id']) ?>">
                                <?= if_empty($safeConductHandover['no_safe_conduct_group'], $safeConductHandover['no_safe_conduct']) ?>
                            </a>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">
                            <?= $safeConductHandover['tep_code'] ?: '-' ?> <?= if_empty($safeConductHandover['no_police'], '', '(', ')') ?>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group <?= form_error('description') == '' ?: 'has-error'; ?>">
                ...
                <textarea class="form-control" id="description" name="description" placeholder="Handover description"
                          maxlength="500"><?= set_value('description', $safeConductHandover['description']) ?></textarea>
