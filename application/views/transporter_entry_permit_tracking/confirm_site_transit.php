<div class="box box-primary">
    ...
    <form action="<?= site_url('transporter-entry-permit-tracking/confirm-site-transit/' . $transporterEntryPermitTracking['id'] . '?redirect=' . get_url_param('redirect')) ?>" role="form" method="post" class="need-validation">
        <?= _method('put') ?>
