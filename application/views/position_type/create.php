<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Create Position Type</h3>
    </div>
    <form action="<?= site_url('position-type/save') ?>" role="form" class="need-validation" method="post">
        <div class="box-body">
            ...
            <div class="form-group <?= form_error('position_type') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control" id="position_type" name="position_type"
                       ...
                       required maxlength="50" value="<?= set_value('position_type') ?>">
                ...
                <div class="col-sm-6">
                    <div class="form-group <?= form_error('color') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="color" class="form-control" id="color" name="color"
                               ...
                               required maxlength="50" value="<?= set_value('color') ?>">
        ...
        <div class="box-footer clearfix">
            ...
            <button type="submit" data-toggle="one-touch" class="btn btn-success pull-right">Save Position Type</button>
        </div>
    </form>
</div>