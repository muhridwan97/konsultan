<form action="<?= site_url('branch/save') ?>" role="form" class="need-validation" method="post">
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="form-group <?= form_error('branch') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control" id="branch" name="branch"
                       ...
                       required maxlength="50" value="<?= set_value('branch') ?>">
            ...
            <div class="form-group <?= form_error('address') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control" id="address" name="address"
                       ...
                       required maxlength="300" value="<?= set_value('address') ?>">
            ...
            <div class="form-group <?= form_error('pic') == '' ?: 'has-error'; ?>">
                ...
                <select class="form-control select2" required name="pic" id="pic"
                    ...
                    <?php foreach($employees AS $employee): ?>
                        <option value="<?= $employee['id'] ?>"<?= set_select('pic', $employee['id']) ?>><?= $employee['name'] ?></option>
                    <?php endforeach; ?>
                </select>
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('contact') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" id="contact" name="contact"
                               ...
                               required maxlength="50" value="<?= set_value('contact') ?>">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group <?= form_error('dashboard_status') == '' ?: 'has-error'; ?>">
                        <label for="visible">Dashboard Status</label>
                        <div class="row">
                            <div class="col-sm-5">
                                <label for="visible">
                                    <input type="radio" id="visible" name="dashboard_status" value="1" checked> Visible
                                </label>
                            </div>
                            <div class="col-sm-6">
                                <label for="not-Visible">
                                    <input type="radio" id="not-Visible" name="dashboard_status" value="0"> Not Visible
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form-group <?= form_error('tally_check_approval') == '' ?: 'has-error'; ?>">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                ...
                                <?= set_radio('tally_check_approval', 1, true) ?>> Active
                                </label>
                            </div>
                            <div class="col-sm-6">
                                <label for="tally_check_approval_inactive">
                                    <input type="radio" id="tally_check_approval_inactive" name="tally_check_approval" value="0"
                                        <?= set_radio('tally_check_approval', 0) ?>> Inactive
                                </label>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('cycle_count_day') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="cycle_count_day" name="cycle_count_day" min="0" placeholder="Branch cycle count day" required maxlength="500" value="<?= set_value('cycle_count_day') ?>">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group <?= form_error('cycle_count_goods') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="cycle_count_goods" name="cycle_count_goods" min="0" placeholder="Branch cycle count goods" required maxlength="500" value="<?= set_value('cycle_count_goods') ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('cycle_count_container') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="cycle_count_container" name="cycle_count_container" min="0" placeholder="Branch cycle count goods" required maxlength="500" value="<?= set_value('cycle_count_container') ?>">
            ...
            <div class="row">
                    ...
                    <div class="form-group <?= form_error('opname_day_name') == '' ?: 'has-error'; ?>">
                        ...
                        <select class="form-control select2" required name="opname_day_name" id="opname_day_name"
                            ...
                            <?php foreach($get_days AS $day): ?>
                                <option value="<?= $day ?>"<?= set_select('opname_day_name', $day) ?>><?= $day ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('opname_day') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="opname_day" name="opname_day" min="0" placeholder="Branch opname day" required maxlength="500" value="<?= set_value('opname_day') ?>">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group <?= form_error('opname_pending_day') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="opname_pending_day" name="opname_pending_day" min="0" placeholder="Branch opname pending day" required maxlength="500" value="<?= set_value('opname_pending_day') ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('email_compliance') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="email" class="form-control" multiple id="email_compliance" name="email_compliance"
                               placeholder="Email compliance" required value="<?= set_value('email_compliance') ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('email_support') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="email" class="form-control" multiple id="email_support" name="email_support"
                               placeholder="Email Support" required value="<?= set_value('email_support') ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('email_operational') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="email" class="form-control" multiple id="email_operational" name="email_operational"
                               placeholder="Email Operational" required value="<?= set_value('email_operational') ?>">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group <?= form_error('branch_type') == '' ?: 'has-error'; ?>">
                        ...
                        <select class="form-control select2" required name="branch_type" id="branch_type" data-placeholder="Select Branch Type" style="width: 100%">
                            <option value=""></option>
                            <option value="PLB"<?= set_select('branch_type', 'PLB') ?>>PLB</option>
                            <option value="TPP"<?= set_select('branch_type', 'TPP') ?>>TPP</option>
                            <option value="GU"<?= set_select('branch_type', 'GU') ?>>GU</option>
                        </select>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group <?= form_error('do_notif') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="do_notif" name="do_notif" value="<?= set_value('do_notif') ?>"
                               min="0" placeholder="Number of days for DO Notification" required maxlength="500">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('whatsapp_group_security') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" id="whatsapp_group_security" name="whatsapp_group_security"
                               ...
                               value="<?= set_value('whatsapp_group_security') ?>">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group <?= form_error('max_slot_tep') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="max_slot_tep" name="max_slot_tep" min="0" placeholder="Number of max slot tep" value="<?= set_value('max_slot_tep') ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('branch_vms') == '' ?: 'has-error'; ?>">
                        ...
                        <select class="form-control select2" name="branch_vms" id="branch_vms"
                            ...
                            <option value="<?= $branch_vms['id'] ?>"><?= $branch_vms['branch'] ?></option>
                            <?php endforeach; ?>
                        </select>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group <?= form_error('branch_hr') == '' ?: 'has-error'; ?>">
                        ...
                        <select class="form-control select2" name="branch_hr" id="branch_hr"
                            ...
                            <option value="<?= $branch_hr['id'] ?>"><?= $branch_hr['location'] ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-md-3">
                    <div class="form-group <?= form_error('stock_pallet') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="stock_pallet" name="stock_pallet" min="0" placeholder="Number of Stock Pallet" value="<?= set_value('stock_pallet') ?>" >
                ...
                <div class="col-md-3">
                    <div class="form-group <?= form_error('initial_pallet') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="initial_pallet" name="initial_pallet" min="0" placeholder="Number of Initial Pallet Stock" value="<?= set_value('initial_pallet') ?>" >
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('qr_code_status') == '' ?: 'has-error'; ?>">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <label for="visible">
                                    <input type="radio" id="visible" name="qr_code_status" value="1"> Visible
                                </label>
                            </div>
                            <div class="col-sm-4">
                                <label for="not-Visible">
                                    <input type="radio" id="not-Visible" name="qr_code_status" value="0" checked> Not Visible
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group <?= form_error('kpi_inbound_do') == '' ?: 'has-error'; ?>">
                                ...
                                <input type="number" class="form-control" id="kpi_inbound_do" name="kpi_inbound_do" min="0" placeholder="Inbound DO" value="<?= set_value('kpi_inbound_do') ?>" >
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group <?= form_error('kpi_inbound_sppb') == '' ?: 'has-error'; ?>">
                                ...
                                <input type="number" class="form-control" id="kpi_inbound_sppb" name="kpi_inbound_sppb" min="0" placeholder="Inbound SPPB" value="<?= set_value('kpi_inbound_sppb') ?>" >
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group <?= form_error('kpi_inbound_gate_in') == '' ?: 'has-error'; ?>">
                                ...
                                <input type="number" class="form-control" id="kpi_inbound_gate_in" name="kpi_inbound_gate_in" min="0" placeholder="Inbound Gate In" value="<?= set_value('kpi_inbound_gate_in') ?>" >
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group <?= form_error('kpi_inbound_stripping') == '' ?: 'has-error'; ?>">
                                ...
                                <input type="number" class="form-control" id="kpi_inbound_stripping" name="kpi_inbound_stripping" min="0" placeholder="Inbound Stripping" value="<?= set_value('kpi_inbound_stripping') ?>" >
        ...
        <div class="box-footer clearfix">
            ...
            <button type="submit" data-toggle="one-touch" class="btn btn-success pull-right">Save Branch</button>
        </div>
    </div>
</form>