<div class="box box-primary">
    ...
    <form action="<?= site_url('warehouse/update/'.$warehouse['id']) ?>" role="form" class="need-validation" method="post">
        <div class="box-body">
            ...
            <div class="form-group <?= form_error('branch') == '' ?: 'has-error'; ?>">
                ...
                <select class="form-control select2" name="branch" id="branch" data-placeholder="Select branch" required>
                    ...
                    <?php foreach ($branches as $branch): ?>
                        <option value="<?= $branch['id'] ?>" <?= set_value('branch', $warehouse['id_branch']) == $branch['id'] ? 'selected' : '' ?>>
                            <?= $branch['branch'] ?>
                        </option>
                    <?php endforeach ?>
                </select>
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('warehouse') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" id="warehouse" name="warehouse"
                               ...
                               required maxlength="50" value="<?= set_value('warehouse', $warehouse['warehouse']) ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('type') == '' ?: 'has-error'; ?>">
                        ...
                        <select name="type" id="type" class="form-control select2" style="width: 100%">
                            <option value="YARD"<?= set_select('type', 'YARD', in_array($warehouse['type'], ['YARD', 'FIELD'])) ?>>FIELD / YARD</option>
                            <option value="COVERED YARD"<?= set_select('type', 'COVERED YARD', $warehouse['type'] == 'COVERED YARD') ?>>COVERED YARD</option>
                            <option value="WAREHOUSE"<?= set_select('type', 'WAREHOUSE', $warehouse['type'] == 'WAREHOUSE') ?>>WAREHOUSE</option>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('total_column') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="total_column" name="total_column"
                               ...
                               required maxlength="50" value="<?= set_value('total_column', $warehouse['total_column']) ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('total_row') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="total_row" name="total_row"
                               ...
                               required maxlength="50" value="<?= set_value('total_row', $warehouse['total_row']) ?>">
            ...
            <div class="form-group <?= form_error('description') == '' ?: 'has-error'; ?>">
                ...
                <textarea class="form-control" id="description" name="description" placeholder="Warehouse description"
                          maxlength="500"><?= set_value('description', $warehouse['description']) ?></textarea>
                <?= form_error('description', '<span class="help-block">', '</span>'); ?>
            </div>
        </div>
        <div class="box-footer clearfix">
            <a href="javascript:void();" onclick="window.history.back()" class="btn btn-primary">Back</a>
            <button type="submit" data-toggle="one-touch" class="btn btn-success pull-right">Update Warehouse</button>
        </div>
    </form>
</div>