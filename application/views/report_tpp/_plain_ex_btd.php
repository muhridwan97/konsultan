...
<table style="width: 100%" border="1">
    ...
    <?php foreach ($reports as $report): ?>
        <tr>
            ...
            <td><?= readable_date($report['reference_date'], '-') ?></td>
            ...
            <td><?= readable_date($report['booking_date'], false) ?></td>
            <td><?= if_empty($report['kep_btd_lelang'], '-') ?></td>
            <td><?= readable_date($report['kep_btd_date'], false) ?></td>
            <td><?= if_empty($report['kep_bmn_lelang'], '-') ?></td>
            <td><?= readable_date($report['kep_bmn_date'], false) ?></td>
