    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <table class="table table-bordered table-striped no-datatable">
                ...
                <tbody>
                <?php foreach ($safeConductChecklistsIn as $index => $checklistsIn): ?>
                    <tr>
                        <td><?= $index + 1 ?></td>
                        <td>
                ...
                <?php foreach ($attachmentSealIn as $index => $checklistsIn): ?>
                    <tr>
                        <td><?= count($safeConductChecklistsIn) + $index + 1 ?></td>
                        <td>
                ...
                <?php endforeach; ?>
                <?php if (empty($safeConductChecklistsIn) && empty($attachmentSealIn)): ?>
                    <tr>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <table class="table table-bordered table-striped no-datatable">
                ...
                <tbody>
                <?php foreach ($safeConductChecklistsOut as $index => $checklistsOut): ?>
                    <tr>
                        <td><?= $index + 1 ?></td>
                        <td>
                ...
                <?php endforeach; ?>
                <?php if (empty($safeConductChecklistsOut) && empty($attachmentSealOut)): ?>
                    <tr>
