...
<p>
    Today, on <strong><?= date('l') ?> <?= date('dS') ?> of <?= date('F') ?>, <?= date('Y') ?></strong>
    whom declare the statement,
    <strong><?= $firstPerson ?></strong> who next is called GRANT HOLDER (first person) and
    <strong><?= $secondPerson ?></strong> who next is called PROPOSED GRANT HOLDER (second person).
</p>
<p>
    GRANT HOLDER handover items to PROPOSED GRANT HOLDER, and then PROPOSED GRANT HOLDER willing to
    take over the grant and all items described below with all its associated responsibility.
</p>
...
<p style="margin-top: 20px">
    The handover report was made by two grant holder and the items that described
    above have received in good condition or with or without remark, thank you.
</p>
