                                        ...
                                        <table class="table table-condensed table-bordered no-datatable responsive">
                                            ...
                                            <?php foreach ($container['goods'] as $item): ?>
                                                <tr>
                                                    ...
                                                    <td><?= numerical($item['unit_volume'], 3, true) ?> M<sup>3</sup></td>
                                                    <td><?= numerical($item['total_volume'], 3, true) ?> M<sup>3</sup></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <?php if($item['total_photo'] > 0): ?>
                                                        <a href="<?= site_url('work-order-goods-photo/edit-by-tally/' . $item['id']) ?>" class="btn btn-primary" title="Total photo <?= $item['total_photo'] ?>">
                                                            View Photo
                                                        </a>
                                                        <?php else: ?>
                                                            <a href="<?= site_url('work-order-goods-photo/edit-by-tally/' . $item['id']) ?>" class="btn btn-primary" title="Total photo <?= $item['total_photo'] ?>">
                                    ...
                                    <table class="table table-condensed no-datatable">
                                        ...
                                        <?php foreach ($item['goods'] as $itemGoods): ?>
                                            <tr>
                                                ...
                                                <td><?= numerical($itemGoods['unit_volume'], 3, true) ?> M<sup>3</sup></td>
                                                <td><?= numerical($itemGoods['total_volume'], 3, true) ?> M<sup>3</sup></td>
                                                <td>
