<div class="box box-primary" id="modal-confirm-check-tally">
    <div class="box-header">
        <h3 class="box-title">Job Component</h3>
    </div>
    <div class="box-body">
            ...
            <div class="row" id="checkbox-resources">
                ...
                <div class="col-sm-4">
                    <div class="checkbox" style="margin-top: 0">
                        <label>
                            <input type="checkbox" name="resources[]" id="resources_<?= $resources_type['id'] ?>" value="<?= $resources_type['id'] ?>" data-component="<?= $resources_type['handling_component'] ?>"
                ...
                <div id="forklift-wrapper" style="display:none">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group col-xs-12">
                                <input type="text" value="<?= $component_data['data_forklift']['operator_name'] ?>" name="operator_name" id="operator_name" class="form-control" placeholder="Operator name" maxlength="50">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group col-xs-12">
                                <input type="number" value="<?= $component_data['data_forklift']['capacity'] ?>" min="0" max="100" step="1" name="capacity" id="capacity" class="form-control" placeholder="Capacity">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="pallet-wrapper" style="display:none">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group col-xs-12">
                                <input type="number" value="<?= set_value('space', abs($workOrder['stock_pallet'])) ?>" min="0" step="1" name="pallet" id="pallet" class="form-control" placeholder="Stock Pallet">
                            </div>
                        </div>
                    </div>
                </div>
