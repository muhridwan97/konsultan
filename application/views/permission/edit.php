<div class="box box-primary">
    ...
    <form action="<?= site_url('permission/update/'.$permission['id']) ?>" role="form" method="post">
        <div class="box-body">
            <!-- alert -->
            ...
            <div class="form-group <?= form_error('module') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control" id="module" name="module"
                       ...
                       required maxlength="50" value="<?= set_value('module', $permission['module']) ?>">
            ...
            <div class="form-group <?= form_error('submodule') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control" id="submodule" name="submodule"
                       ...
                       required maxlength="50" value="<?= set_value('submodule', $permission['submodule']) ?>">
			...
			<div class="form-group <?= form_error('permission') == '' ?: 'has-error'; ?>">
                ...
                <input type="text" class="form-control" id="permission" name="permission"
                       ...
                       required maxlength="50" value="<?= set_value('permission', $permission['permission']) ?>">
            ...
            <div class="form-group <?= form_error('description') == '' ?: 'has-error'; ?>">
                ...
                <textarea class="form-control" id="description" name="description" placeholder="Permission description"
                          required maxlength="500"><?= set_value('description', $permission['description']) ?></textarea>
                <?= form_error('description', '<span class="help-block">', '</span>'); ?>
            </div>
        </div>
        <div class="box-footer">
			<a href="<?= site_url('permission') ?>" class="btn btn-primary">Back to Permissions List</a>
            <button type="submit" data-toggle="one-touch" class="btn btn-warning pull-right">Update Permission</button>
        </div>
    </form>
</div>