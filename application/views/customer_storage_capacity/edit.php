<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Edit Customer Storage</h3>
    </div>

    <form action="<?= site_url('customer-storage-capacity/update/' . $customerStorageCapacity['id']) ?>" role="form" method="post" class="need-validation" id="form-customer-storage-capacity">
        <?= _method('put') ?>
        ...
        <div class="box-body">
                ...
                <div class="col-md-4">
                    <div class="form-group <?= form_error('effective_date') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control datepicker" id="effective_date" name="effective_date"
                               ...
                               required value="<?= set_value('effective_date', format_date($customerStorageCapacity['effective_date'], 'd F Y')) ?>">
                ...
                <div class="col-md-8">
                    <div class="form-group <?= form_error('expired_date') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control datepicker" id="expired_date" name="expired_date"
                               ...
                               required value="<?= set_value('expired_date', format_date($customerStorageCapacity['expired_date'], 'd F Y')) ?>">
                ...
                <div class="col-md-4">
                    <div class="form-group <?= form_error('warehouse_capacity') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="warehouse_capacity" name="warehouse_capacity"
                               ...
                               required maxlength="15" min="0" max="50000" value="<?= set_value('warehouse_capacity', $customerStorageCapacity['warehouse_capacity']) ?>">
                ...
                <div class="col-md-4">
                    <div class="form-group <?= form_error('yard_capacity') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="yard_capacity" name="yard_capacity"
                               ...
                               required maxlength="15" min="0" max="50000" value="<?= set_value('yard_capacity', $customerStorageCapacity['yard_capacity']) ?>">
                ...
                <div class="col-md-4">
                    <div class="form-group <?= form_error('covered_yard_capacity') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="number" class="form-control" id="covered_yard_capacity" name="covered_yard_capacity"
                               ...
                               required maxlength="15" min="0" max="50000" value="<?= set_value('covered_yard_capacity', $customerStorageCapacity['covered_yard_capacity']) ?>">
            ...
            <div class="form-group <?= form_error('description') == '' ?: 'has-error'; ?>">
                ...
                <textarea class="form-control" id="description" name="description" placeholder="Storage update description"
                          maxlength="500"><?= set_value('description', $customerStorageCapacity['description']) ?></textarea>
