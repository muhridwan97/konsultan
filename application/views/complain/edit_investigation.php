        ...
        <div class="box-body">
            ...
            <div class="form-group <?= form_error('complain') == '' ?: 'has-error'; ?> complain-class">
                <label for="complain">Investigation</label>
                 <textarea class="form-control" id="investigation" name="investigation" placeholder="Enter Investigation" maxlength="500"><?= set_value('investigation',$complain['investigation_result']) ?></textarea>
             ...
             <div class="form-group <?= form_error('corrective') == '' ?: 'has-error'; ?>">
                <label for="corrective">Corrective</label>
                 <textarea class="form-control" id="corrective" name="corrective" placeholder="Enter Corrective" maxlength="500"><?= set_value('corrective',$complain['corrective']) ?></textarea>
            ...
            <div class="form-group <?= form_error('prevention') == '' ?: 'has-error'; ?>">
                <label for="prevention">Prevention</label>
                 <textarea class="form-control" id="prevention" name="prevention" placeholder="Enter Prevention" maxlength="500"><?= set_value('prevention',$complain['prevention']) ?></textarea>
