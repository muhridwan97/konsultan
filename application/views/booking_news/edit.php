<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Edit Booking Report</h3>
    </div>

    <form action="<?= site_url('booking_news/update/' . $bookingNews['id']) ?>" role="form" method="post" id="form-booking-news">
        <input type="hidden" name="id" id="id" value="<?= $bookingNews['id'] ?>">
        ...
        <div class="box-body">
                ...
                <div class="form-group <?= form_error('branch') == '' ?: 'has-error'; ?>">
                    ...
                    <select class="form-control select2" name="branch" id="branch" data-placeholder="Select branch" required>
                        ...
                        <?php foreach (get_customer_branch() as $branch): ?>
                            <option value="<?= $branch['id'] ?>" <?= set_select('branch', $branch['id'], $branch['id'] == $bookingNews['id_branch']) ?>>
                                <?= $branch['branch'] ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="form-group <?= form_error('type') == '' ?: 'has-error'; ?>">
                ...
                <select class="form-control select2" name="type" id="type" data-placeholder="Select report type" required>
                    <option value=""></option>
                    <option value="WITHDRAWAL" <?= set_select('type', 'WITHDRAWAL', $bookingNews['type'] == 'WITHDRAWAL') ?>>WITHDRAWAL</option>
                    <option value="CANCELING" <?= set_select('type', 'CANCELING', $bookingNews['type'] == 'CANCELING') ?>>CANCELING</option>
                </select>
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('no_booking_news') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" data-mask="00000" name="no_booking_news" id="no_booking_news" class="form-control" required
                               placeholder="No booking news" value="<?= set_value('no_booking_news', $bookingNews['no_booking_news']) ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('booking_news_date') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control datepicker" id="booking_news_date" name="booking_news_date"
                               ...
                               value="<?= set_value('booking_news_date', (new DateTime($bookingNews['booking_news_date']))->format('d F Y')) ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('no_sprint') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" name="no_sprint" id="no_sprint" class="form-control" required
                               placeholder="S-XXXXX/KPU.XX/BD.XXXX/XXXX" value="<?= set_value('no_sprint', $bookingNews['no_sprint']) ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('sprint_date') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control datepicker" id="sprint_date" name="sprint_date"
                               placeholder="BA date" required
                               value="<?= set_value('sprint_date', (new DateTime($bookingNews['sprint_date']))->format('d F Y')) ?>">
            ...
            <div class="form-group <?= form_error('tps') == '' ?: 'has-error'; ?>">
                ...
                <select class="form-control select2" name="tps" id="tps" data-placeholder="Select TPS" required>
                    ...
                    <?php foreach ($tps as $row): ?>
                        <option value="<?= $row['name'] ?>" <?= set_select('tps', $row['name'], $bookingNews['tps'] == $row['name']) ?>>
                            <?= $row['name'] ?>
                        </option>
                    <?php endforeach; ?>
                </select>
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('chief_name') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" name="chief_name" id="chief_name" class="form-control" required
                               placeholder="Chief full name" value="<?= set_value('chief_name', $bookingNews['chief_name']) ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group <?= form_error('chief_nip') == '' ?: 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" id="chief_nip" name="chief_nip"  required
                               placeholder="Chief NIP" value="<?= set_value('chief_nip', $bookingNews['chief_nip']) ?>">
            ...
            <div class="form-group <?= form_error('description') == '' ?: 'has-error'; ?>">
                ...
                <textarea class="form-control" id="description" name="description" placeholder="Report description"
                          required maxlength="500"><?= set_value('description', $bookingNews['description']) ?></textarea>
                <?= form_error('description', '<span class="help-block">', '</span>'); ?>
            </div>

            <?php $this->load->view('booking_news/_booking', [
                'bookingData' => $bookingNewsDetails
            ]) ?>
        ...
        <div class="box-footer clearfix">
            ...
            <button type="submit" class="btn btn-primary pull-right" id="btn-save-booking-news">
                Save Booking Report
            </button>
        </div>
    </form>
